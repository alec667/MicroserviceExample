...
class VentasControllerTest {
        ...
        void getVenta() throws Exception {
                ...
                mockMvc.perform(mockRequest)
                                ...
                                .andExpect(jsonPath("$.producto", Objects.requireNonNull(is("product 1"))));
        }
        ...
        void getAllVentas() throws Exception {
                ...
                mockMvc.perform(mockRequest)
                                .andExpect(status().isOk())
                                .andExpect(jsonPath("$", Objects.requireNonNull(notNullValue())))
                                .andExpect(jsonPath("$[0].producto", Objects.requireNonNull(is("product 1"))))
                                .andExpect(jsonPath("$[1].producto", Objects.requireNonNull(is("product 2"))));
        }
        ...
        void updateVenta() throws Exception {
                ...
                mockMvc.perform(mockRequest)
                                .andExpect(status().isOk())
                                .andExpect(jsonPath("$", Objects.requireNonNull(notNullValue())))
                                .andExpect(jsonPath("$.producto", Objects.requireNonNull(is("product 2"))));
        }
