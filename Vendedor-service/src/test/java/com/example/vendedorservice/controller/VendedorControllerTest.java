...
class VendedorControllerTest {
        ...
        void getVendedor() throws Exception {
                ...
                mockMvc.perform(request)
                                ...
                                .andExpect(jsonPath("$.vendedorName", Objects.requireNonNull(Matchers.is("name1"))));
        }
        ...
        void getAllVendedor() throws Exception {
                ...
                mockMvc.perform(request)
                                .andExpect(status().isOk())
                                .andExpect(jsonPath("$", Objects.requireNonNull(notNullValue())))
                                .andExpect(jsonPath("$[0].vendedorName", Objects.requireNonNull(is("name1"))));
        }
        ...
        void updateVendedor() throws Exception {
                ...
                mockMvc.perform(request)
                                .andExpect(status().isOk())
                                .andExpect(jsonPath("$", Objects.requireNonNull(notNullValue())))
                                .andExpect(jsonPath("$.vendedorPhone",
                                                Objects.requireNonNull(is("phone 2 (updated)"))));
        }
        ...
        void deleteVendedor() throws Exception {
                ...
                mockMvc.perform(request)
                                .andExpect(status().isOk())
                                .andExpect(result -> assertThat(result.getResponse().getContentAsString())
                                                .isEqualTo("Vendedor Id: 2 BORRADO."));
        }
}